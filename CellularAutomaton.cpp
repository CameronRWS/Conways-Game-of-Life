...
CellularAutomaton::CellularAutomaton(int width, int height, unsigned char quiescentState, unsigned char shouldWrapFlag) {
    ...
    this->initCA(); //Set all the values of the CA to the quiescentState.
}
 ...
 */
CellularAutomaton::CellularAutomaton(const CellularAutomaton& originalCA) : cadata(NULL) {
